...
{
    VCLog(@"usrID:%@, cookie:%@", usrID, cookie);
...
{
    VCLog(@"sdkErr:%u, cookie:%@", sdkErr, cookie);
    dispatch_async(dispatch_get_main_queue(), ^{
...
{
    VCLog(@"meetInfo.ID:%d meetInfo.pswd:%@ meetInfo.subject:%@ meetInfo.pubMeetUrl:%@ cookie:%@", meetInfo.ID, meetInfo.pswd, meetInfo.subject, meetInfo.pubMeetUrl, cookie);
    dispatch_async(dispatch_get_main_queue(), ^{
...
{
    VCLog(@"callID:%@ cookie:%@", callID, cookie);
    dispatch_async(dispatch_get_main_queue(), ^{
...
{
    VCLog(@"callID:%@ sdkErr:%u cookie:%@", callID, sdkErr, cookie);
    dispatch_async(dispatch_get_main_queue(), ^{
...
{
    VCLog(@"callID:%@ meetInfo.ID:%d meetInfo.pswd:%@ meetInfo.subject:%@ meetInfo.pubMeetUrl:%@ callerID:%@ usrExtDat:%@", callID, meetInfo.ID, meetInfo.pswd, meetInfo.subject, meetInfo.pubMeetUrl, callerID, usrExtDat);
    dispatch_async(dispatch_get_main_queue(), ^{
...
{
    VCLog(@"callID:%@ meetInfo.ID:%d meetInfo.pswd:%@ meetInfo.subject:%@ meetInfo.pubMeetUrl:%@ usrExtDat:%@", callID, meetInfo.ID, meetInfo.pswd, meetInfo.subject, meetInfo.pubMeetUrl, usrExtDat);
    dispatch_async(dispatch_get_main_queue(), ^{
...
{
    VCLog(@"callID:%@ reason:%u usrExtDat:%@", callID, reason, usrExtDat);
    dispatch_async(dispatch_get_main_queue(), ^{
...
{
    VCLog(@"callID:%@ usrExtDat:%@", callID, usrExtDat);
    dispatch_async(dispatch_get_main_queue(), ^{
...
{
    VCLog(@"sendId:%@ sdkErr:%u cookie:%@", sendId, sdkErr, cookie);
    dispatch_async(dispatch_get_main_queue(), ^{
...
{
    VCLog(@"sendId:%@ fileName:%@ sdkErr:%u cookie:%@", sendId, fileName, sdkErr, cookie);
    dispatch_async(dispatch_get_main_queue(), ^{
...
{
    VCLog(@"sendId:%@ sendedLen:%d totalLen:%d cookie:%@", sendId, sendedLen, totalLen, cookie);
    dispatch_async(dispatch_get_main_queue(), ^{
...
{
    VCLog(@"sourceUserId:%@ data.lenght:%@ data:%@", sourceUserId, @(data.length),data);
    dispatch_async(dispatch_get_main_queue(), ^{
...
{
    VCLog(@"sourceUserId:%@ data.lenght:%@", sourceUserId, @(data.length));
    dispatch_async(dispatch_get_main_queue(), ^{
...
{
    VCLog(@"sourceUserId:%@ tmpFile:%@ orgFileName:%@", sourceUserId, tmpFile, orgFileName);
    dispatch_async(dispatch_get_main_queue(), ^{
